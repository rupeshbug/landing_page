  ...
  return (
    <div className="py-20 px-5 md:px-20">
      ...
      <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
        <div className="glass-morphism-effect flex space-x-4 px-4 py-6 rounded-lg shadow-md">
        ...
        <div className="glass-morphism-effect flex space-x-4 p-4 rounded-lg shadow-md">
